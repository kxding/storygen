...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def get_processor(self, return_deprecated_lora: bool = False):
        ...
        ##### the bug happens when the code tries to use the name of my custom processor to import a LoRA processor,
        ##### as my use case is still using LoRAAttnProcessor but with some custom codes happened inside 
        ##### so I just hard coded the lora_processor_cls and removed all if else use cases in the original code
    ...
    def get_attn_processors(self):
        ...
        def fn_recursive_add_processors(name: str, module: torch.nn.Module, processors):
            if hasattr(module, "get_processor"):
                processors[f"{name}.processor"] = get_processor(module, return_deprecated_lora=True)  # using the function i defined above instead of module.get_processor to bypass this error
